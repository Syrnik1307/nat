...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,testserver,72.56.81.163,indiscernible-aarav-unmoving.ngrok-free.dev,*.ngrok-free.dev,*').split(',')
