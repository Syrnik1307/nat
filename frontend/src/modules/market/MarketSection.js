    ...
    <div className="market-section">
      ...
      <div className="market-custom-banner">
        ...
        <div className="custom-banner-content">
          <h4>Нужен другой сервис?</h4>
          <p>
            Поможем оплатить любую зарубежную подписку, недоступную с российской карты: 
            ChatGPT, Midjourney, Notion, Figma и другие. Цены ниже рынка.
          </p>
        </div>
        <a 
