...
code, body = get(base + "/accounts/api/admin/teachers/?" + urllib.parse.urlencode({"page": 1, "page_size": 5, "sort": "name", "order": "asc"}))
...
code, body = get(base + "/accounts/api/admin/students/?" + urllib.parse.urlencode({"page": 1, "page_size": 5, "status": "active", "sort": "last_login", "order": "desc"}))
...
if first_tid:
    code, body = get(base + "/accounts/api/admin/students/?" + urllib.parse.urlencode({"page": 1, "page_size": 5, "status": "all", "teacher_id": first_tid}))
...
# archived filter
code, body = get(base + "/accounts/api/admin/students/?" + urllib.parse.urlencode({"page": 1, "page_size": 5, "status": "archived"}))
...
# sort by name asc
code, body = get(base + "/accounts/api/admin/students/?" + urllib.parse.urlencode({"page": 1, "page_size": 5, "status": "active", "sort": "name", "order": "asc"}))
...
code, body = get(base + "/accounts/api/admin/students/?" + urllib.parse.urlencode({"page": 1, "page_size": 5, "status": "active", "sort": "created_at", "order": "desc"}))
